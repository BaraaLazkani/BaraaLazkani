...
[![GitHub Stats](https://github-readme-stats.vercel.app/api?username=BaraaLazkani&show_icons=true&theme=radical)](https://github.com/BaraaLazkani)
[![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=BaraaLazkani&layout=compact&theme=radical)](https://github.com/BaraaLazkani)
[![Profile Views](https://komarev.com/ghpvc/?username=BaraaLazkani&color=blueviolet)](https://github.com/BaraaLazkani)
...
### [From Mapping to Motion: An Integrated Approach to Autonomous Path Planning](https://github.com/BaraaLazkani/From_Mapping_to_Motion_An_Integrated_Approach_to_Autonomous_Path_Planning)
...
**Technologies**: Python, C++, CUDA, Makefile
**Key Contributions**:
...
### [Real-Time Robot Navigation with QR-Based Localization and LIDAR Obstacle Mapping](https://github.com/BaraaLazkani/REAL-TIME-ROBOT-NAVIGATION-WITH-QR-BASED--LOCALIZATION-AND-LIDAR-OBSTACLE-MAPPING)
...
### [YOLOv8-Based Trash Detection System](https://github.com/BaraaLazkani/trash-detection-yolov8)
Deep learning-based waste classification system for automated sorting applications, classifying waste into five categories: Carton, Glass, Metal, Paper, and Plastic.

**Technologies**: Python, YOLOv8, PyTorch
**Key Contributions**:
- Fine-tuned YOLOv8 architecture for waste classification task
- Curated and annotated custom dataset for training and validation
- Achieved high-accuracy multi-class detection suitable for real-world deployment
- Optimized inference pipeline for resource-constrained environments

**Skills Demonstrated**: Object detection, YOLOv8, transfer learning, dataset curation, computer vision

---

### [Trash Level Classification](https://github.com/BaraaLazkani/Trash_Level_Classification)
Machine learning system for automated waste level monitoring in smart city applications.

**Technologies**: Python
**Key Contributions**:
- Developed classification models for waste volume estimation
- Implemented data preprocessing pipeline for sensor data
- Evaluated multiple ML algorithms for optimal performance

**Skills Demonstrated**: Classification algorithms, machine learning, Python, data preprocessing

---

### [Image Processing Projects](https://github.com/BaraaLazkani/Image-Processing-Projects)
Collection of computer vision and image processing implementations exploring classical and modern techniques.

**Technologies**: Python
**Key Contributions**:
- Implemented fundamental image processing algorithms
- Explored various computer vision techniques and their applications
- Developed reusable modules for image analysis tasks

**Skills Demonstrated**: Image processing, computer vision, algorithm implementation, Python

---

### [Differential Drive Robot Simulation](https://github.com/BaraaLazkani/differentail_robot_sim_matlab)
MATLAB-based simulation environment for differential drive robot kinematics and control.

**Technologies**: MATLAB
**Key Contributions**:
- Modeled differential drive kinematics and dynamics
- Implemented control algorithms for trajectory tracking
- Developed visualization tools for robot motion analysis

**Skills Demonstrated**: Robot kinematics, MATLAB simulation, control theory, differential drive systems

---

### [Serial Robots Kinematics and Dynamics](https://github.com/BaraaLazkani/Serial-Robots-Kinematics-Dynamics)
Comprehensive analysis and implementation of forward and inverse kinematics for serial manipulators.

**Technologies**: MATLAB
**Key Contributions**:
- Derived kinematic equations for multi-DOF manipulators
- Implemented inverse kinematics solvers
- Analyzed robot dynamics and workspace characterization

**Skills Demonstrated**: Forward/inverse kinematics, robot dynamics, MATLAB, manipulator analysis

---

## Competition Achievements

### [RoboPegasus Team - WRO 2025](https://github.com/BaraaLazkani/RoboPegasus_Team_WRO2025)
...
### [Scud Storm Team - WRO Future Engineers](https://github.com/BaraaLazkani/Syrian-WRO-Competition-Scud-Storm-sumbission-)
...
**Email**: lazkani.baraa.official@gmail.com
**GitHub**: [@BaraaLazkani](https://github.com/BaraaLazkani)
**Resume** [Resume](https://drive.google.com/file/d/1Eb9i2fFsvn1KTCojW0Uk0sxYo9EKfsU-/view?usp=sharing)

---

<div align="center">
  <i>Advancing robotics through rigorous research and open-source collaboration</i>
</div>
